...
//echo $colonias;
    ...
    <form action="enviando.php" class="registro caja-1-row" method="post" id="formulario-ingresos">
     ...
     <?php include_once 'includes/templates/registrarUsuario.php';?>
 ...
 <div class="formulario__grupo" id="grupo__ingresos">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="ingresos" id="ingresos"  tabindex="1"onchange="MASK(this,this.value,'-$##,###,##0.00',1)" autocomplete="off" required>
