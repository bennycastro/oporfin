 ...
 <link rel="stylesheet" href="css/estilos.css">
   ...
   <section class="seccion contenedor2">
    ...
    <?php
       ...
       $_SESSION['tipo_credito'] = htmlentities ($_POST["tipo_credito"]);
       $tipo_credito = $_SESSION['tipo_credito'];
    ...
    ?>
      ...
      <!-- Grupo: Nombre -->
			<div class="formulario__grupo" id="grupo__segundo_nombre">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" id="segundo-nombre" name="segundo-nombre" >
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
...
<div class="formulario__grupo" id="grupo__apellido_paterno">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="apellido-paterno" id="apellido-paterno">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
      ...
      <!-- Grupo: Nombre -->
			<div class="formulario__grupo" id="grupo__apellido_materno">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="apellido-materno" id="apellido-materno">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
