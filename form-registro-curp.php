    ...
    <h2 class="titulo">Completa tu información <span  class="remarcado"> para continuar </span></h2>
     ...
     <div class="formulario__grupo" id="grupo__curp">
       ...
       <div class="formulario__grupo-input">
         <input type="text" class="formulario__input" name="curp" id="curp"  tabindex="1">
         <i class="formulario__validacion-estado fas fa-times-circle"></i>
       </div>
       <p class="formulario__input-error">Introduzca un Curp Valido (18 Caracteres)</p>
     </div>
     <!-- Grupo: celular -->
     <div class="formulario__grupo" id="grupo__num_celular">
       ...
       <div class="formulario__grupo-input">
         ...
         <input type="tel" class="formulario__input" name="num_celular" id="num_celular"tabindex="2">
...
<div class="formulario__grupo" id="grupo__fijo">
       ...
       <div class="formulario__grupo-input">
         <input type="tel" class="formulario__input" name="num_casa" id="num_casa"tabindex="3">
         <i class="formulario__validacion-estado fas fa-times-circle"></i>
       </div>
       <p class="formulario__input-error">Introduzca un número de telefono a 10 dígitos</p>
     </div>
