   ...
   session_start(); /*Abre la sesion */
     ...
     <!-- Grupo: Correo Electronico -->
			...
			<div class="formulario__grupo" id="grupo__correo">
				...
				<div class="formulario__grupo-input">
					<input type="email" class="formulario__input" name="correo" id="correo" placeholder="tucorreoelectrónico@dominio.com" tabindex="1">
     ...
     <!-- Grupo: Correo Electronico -->
			...
			<div class="formulario__grupo" id="grupo__correo_confirmacion">
				...
				<div class="formulario__grupo-input">
					<input type="email" class="formulario__input" name="correo_confirmacion" id="correo_confirmacion" placeholder="tucorreoelectrónico@dominio.com" tabindex="2">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__password">
				...
				<div class="formulario__grupo-input">
					<input type="password" class="formulario__input" name="password" id="password" tabindex="3">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
       ...
       Al menos una letra mayúscula<br>Al menos una letra minúscula<br>Al menos un caracter especial<br>Sin espacios en blanco
		...
		<!-- Grupo: Contraseña 2-->
			<div class="formulario__grupo" id="grupo__password2">
				...
				<div class="formulario__grupo-input">
					<input type="password" class="formulario__input" name="password2" id="password2" tabindex="4">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
